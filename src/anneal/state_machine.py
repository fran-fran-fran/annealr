...
# Description: AnnealStateMachine - manages run lifecycle, state
...
class AnnealStateMachine:
    ...
    def __init__(self):
        self.log = logging.getLogger('anneal.state')
        self.state = 'idle'
        self.profile = None
        self.stage_index = 0
        self.executor = None
    ...
    def is_active(self):
        """True if an anneal run is in progress (including paused)."""
